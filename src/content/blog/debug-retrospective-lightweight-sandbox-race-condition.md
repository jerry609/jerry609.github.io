...
> **作者**: Debug Team
> **日期**: 2025-12-13
> **关键词**: pexpect, ThreadPoolExecutor, race condition, asyncio, 分布式系统
...
正在为 ROCK 项目实现一个轻量级 Sandbox 运行时（Issue #76），目标是提供一个无需 Docker/Admin 服务器依赖的本地执行环境，支持可选的进程隔离（macOS sandbox-exec / Linux bubblewrap）。
